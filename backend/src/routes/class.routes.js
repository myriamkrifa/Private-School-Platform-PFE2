...
router.get('/', protect, authorize('ADMIN', 'TEACHER', 'STUDENT', 'PARENT'), classController.getAllClasses)
router.get('/:id', protect, authorize('ADMIN', 'TEACHER', 'STUDENT', 'PARENT'), classController.getClassById)
...
router.post('/:id/timetable', protect, authorize('ADMIN', 'TEACHER'), classController.generateClassTimetable)
